...
import {CLPosition} from "v4-core/src/pool-cl/libraries/CLPosition.sol";
...
/// @title NFT positions
/// @notice Wraps DonaSwap V4 positions in the ERC721 non-fungible token interface
    ...
    Multicall
{
    ...
    constructor(IVault _vault, ICLPoolManager _poolManager, address _tokenDescriptor_, address _WETH9)
        ...
        ERC721Permit("DonaSwap V4 Positions NFT-V1", "DONASWAP-V4-POS", "1")
    {
